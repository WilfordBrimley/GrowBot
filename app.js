...
client.ffmpeg = require(`fluent-ffmpeg`);          // Add video processing to client
client.stringToColor = require('string-to-color'); // Does its best to return the color you ask for
/**───────────────────────────────────────────────────────────────── @LOAD_SERVICES ─*/
